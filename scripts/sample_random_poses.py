...
from repogen.random_pose.pose_and_view_generation import generate_pose, random_camera_pose
...
def main(args):
    ...
    with tqdm(total=args.num_views * args.num_poses, ascii=True) as progress_bar:
        ...
        for pose_i in range(args.num_poses):
            ...
            model = repogen.create(args.model_folder, model_type=args.model_type,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-type', default='repogen', type=str,
